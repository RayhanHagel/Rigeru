  ...
  return (
    <div className="w-full h-full p-6 lg:p-10 relative z-10 overflow-y-auto animate-slide-up flex flex-col font-sans">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 border-b border-primary/30 pb-4 shrink-0">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">AI Background Remover</h1>
          <p className="text-zinc-400 text-sm font-medium">Remove image backgrounds instantly in high quality.</p>
        </div>
              ...
              <ModernTabContent activeTab="batch">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center justify-between bg-zinc-950 p-4 rounded-xl border border-white/5">
                    ...
                    <Button variant="secondary" size="sm" onClick={() => setIsFolderExplorerOpen(true)}>
                      Select Folder
                    </Button>
                  </div>
                </div>
