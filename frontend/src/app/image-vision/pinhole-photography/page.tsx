  ...
  return (
    <div className="w-full h-full p-6 lg:p-10 relative z-10 overflow-y-auto animate-slide-up flex flex-col font-sans">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 border-b border-primary/30 pb-4 shrink-0">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Pinhole Photography</h1>
          <p className="text-zinc-400 text-sm font-medium">Turn a video into a single long-exposure photograph.</p>
        </div>
                    ...
                    <div className="flex items-center justify-between bg-zinc-950 p-4 rounded-xl border border-white/5">
                      <div className="flex items-center gap-3 overflow-hidden">
                        ...
                        <div className="truncate">
                          ...
                          <p className="text-xs text-zinc-500">Batch process multiple videos</p>
                        </div>
                      </div>
                      <Button
                        variant="secondary"
            ...
            <div className="flex-1 w-full bg-black/50 rounded-xl border border-white/5 relative overflow-hidden min-h-[400px] flex items-center justify-center p-4">
              {processedUrls.length === 0 ? (
                ...
                <div className="w-full h-full flex flex-col gap-4">
                  <div
                    className="w-full flex-1 relative bg-zinc-950 rounded-lg overflow-hidden border border-white/10 cursor-pointer group"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <span className="text-sm font-medium text-white">Zoom Fullscreen</span>
                    </div>
                  </div>
                </div>
              ) : (
